...
ResultSet itemList = st.executeQuery("select userId, bidAmt, bidTime from bid where itemId ="+itemId);
%>
<br><br>
    	<TABLE align="center" BORDER="1">
    	<caption style="text-align:center">Bidding history of item</caption>
            <TR>
                <TH>Name</TH>
                <TH>Bid Amount</TH>
                <TH>Bid Time</TH>
            ...
            %>
            <TR>
            	<TD> <a href="histAuction.jsp?userId=<%=itemList.getString(1)%>"><%=itemList.getString(1)%></a></TD>
