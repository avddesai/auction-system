...
ResultSet itemList = st.executeQuery("SELECT i.name, SUM(bidAmt) FROM sales s inner join item i on s.itemId = i.itemId GROUP BY i.name ORDER BY SUM(bidAmt) DESC;");
...
<table align="center">
    	...
    	<caption style="text-align:center"></caption>
    	    <p style="text-align:center" >Sales per Item</p>
            <TR>
                <TH>item Name</TH>
                <TH>sales</TH>
