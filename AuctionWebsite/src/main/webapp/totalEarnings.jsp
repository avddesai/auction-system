...
ResultSet itemList = st.executeQuery("select * from sales");
...
%>
    	...
    	<caption style="text-align:center">Sales</caption>
            <TR>
                <TH>SalesId</TH>
                <TH>userId</TH>
                <TH>itemId</TH>
            ...
            <TR>
                ...
                <TD> <%= itemList.getInt(3) %></TD>
                <TD> <%= itemList.getInt(4) %></TD>
            </TR>
            <%
            } 
            %>
