...
ResultSet itemList = st.executeQuery("Select i.userId,SUM(s.bidAmt) from sales s inner join item i on i.itemId = s.itemId GROUP BY i.userId;");
...
<table align="center">
    	...
    	<caption style="text-align:center"></caption>
    	    <p style="text-align:center" >Sales per User</p>
            <TR>
                <TH>User</TH>
                <TH>Sales</TH>
