...
ResultSet itemList = st.executeQuery("select distinct i.name, b.bidAmt, b.bidTime from bid b inner join item i on b.itemId = i.itemId where b.userId ='"+searchUserId+"'");
%>
<br><br>
    	<TABLE align="center" BORDER="1">
    	<caption style="text-align:center">User's history in auctions</caption>
            <TR>
                <TH>Item Name</TH>
                <TH>Bid Amount</TH>
                <TH>Bid Time</TH>
